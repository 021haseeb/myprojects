...
--update tbank_atm set b_name= 'Ali',b_address='xuhjyyz multan'
--where id = 12;
...
--------------------joins-------------------
SELECT  costumer.cos_sr,costumer. cos_name,account.acc_sr
FROM costumer 
INNER JOIN account 
ON costumer.cos_sr= account.acc_sr;

SELECT  costumer.cos_id,account.acc_sr
FROM costumer 
full JOIN account 
ON costumer.cos_sr= account.acc_sr;

SELECT  costumer.cos_name,account.acc_sr
FROM costumer 
INNER JOIN account 
ON costumer.cos_sr= account.acc_sr;
SELECT *
...
--select  trans_type, trans_status from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type = 'payment' )
--select  trans_status, trans_type from  transaction_atm where trans_status in (select trans_status from transaction_atm where trans_status  =  'success' )
--select trans_type from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type = 'payment' )
--select  trans_status from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type ='purchasing' )
--select *  from  transaction_atm where trans_status in (select trans_status from transaction_atm where trans_status= 'cancelled')

--select   * from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type = 'cancelled' and trans_time =  'night' )
--select  trans_time, trans_type from  transaction_atm where trans_status in (select trans_status from transaction_atm where trans_status  =  'success' )
--select trans_type from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type= 'purchasing' and trans_time = 'morning' )
--select * from  transaction_atm where trans_status in (select trans_status from transaction_atm where  trans_type ='purchasing' )
--select *  from  transaction_atm where trans_status in (select trans_status from transaction_atm where trans_status= 'cancelled')
...
----------SUBQUIRIES-------
--Select * from operator where o_id = (select  o_id = 098007 )
--Select * from operator where o_id = (select  o_id =098008 )
--Select * from operator where o_id = (select  o_id = 098017 )
--Select * from operator where o_name = (select  o_name= 'aneeq' )
--Select * from operator where o_name = (select  o_name ='sweba'  )
--Select * from operator where o_name = (select  o_name = 'umama' )
--Select * from operator where o_name = (select  o_name= 'aneeq' )
--Select * from operator where o_name = (select  o_name ='sweba'  )
--Select  o_name from operator where o_name = (select  o_name = 'bilal' )
--Select * from operator where o_id = (select  o_id= 098003 )
